...
def copy_Files(destination):
    ...
    copy("/kaggle/working/eval_ssl_ssc/main.py", os.path.join(destination_dir, "main.py"))
    copy("/kaggle/working/eval_ssl_ssc/dataloader/dataloader.py", os.path.join(destination_dir, "dataloader.py"))
    copy("/kaggle/working/eval_ssl_ssc/dataloader/ts_augmentations.py", os.path.join(destination_dir, "ts_augmentations.py"))
    copy(f"/kaggle/working/eval_ssl_ssc/models/models.py", os.path.join(destination_dir, f"models.py"))
    copy(f"/kaggle/working/eval_ssl_ssc/models/loss.py", os.path.join(destination_dir, f"loss.py"))
    copy("/kaggle/working/eval_ssl_ssc/algorithms.py", os.path.join(destination_dir, "algorithms.py"))
    copy(f"/kaggle/working/eval_ssl_ssc/configs/data_configs.py", os.path.join(destination_dir, f"data_configs.py"))
    copy(f"/kaggle/working/eval_ssl_ssc/configs/hparams.py", os.path.join(destination_dir, f"hparams.py"))
    copy(f"/kaggle/working/eval_ssl_ssc/trainer.py", os.path.join(destination_dir, f"trainer.py"))
    copy("/kaggle/working/eval_ssl_ssc/utils.py", os.path.join(destination_dir, "utils.py"))
